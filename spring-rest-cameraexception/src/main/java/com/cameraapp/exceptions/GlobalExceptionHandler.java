...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleCamNotFound(Exception ex) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("desc", "Camera not available");
        String error = ex.getMessage();
        List<String> messages = Arrays.asList(error,"Camera not found");
